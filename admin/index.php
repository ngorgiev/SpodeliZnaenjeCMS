                ...
                <div class="row">
                    <script type="text/javascript">
                        ...
                        <?php
                            ...
                            $element_count = [$post_counts,$post_published_count, $post_draft_count, $categories_counts, $users_counts, $subscribers_count, $comments_counts, $unapproved_comments_count];
